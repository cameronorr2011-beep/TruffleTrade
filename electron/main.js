...
async function startServer() {
  ...
  if (app.isPackaged) {
    if (!process.env.TT_GATEWAY_URL) process.env.TT_GATEWAY_URL = "https://truffletrade-orr5.vercel.app";
    if (!process.env.TT_SITE_URL) process.env.TT_SITE_URL = "https://truffletrade-orr5.vercel.app";
