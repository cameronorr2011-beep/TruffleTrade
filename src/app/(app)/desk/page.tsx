    ...
    <div className="mx-auto max-w-[1280px] px-5 pb-24 pt-10 sm:px-8">
      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-4">
        <div className="card p-6">
          <p className="font-mono text-[0.6rem] uppercase tracking-[0.24em] text-bone-soft">Equity (mark)</p>
          <p className="font-display mt-2 text-[2rem] font-semibold text-ink">{usd(a.equityUsd)}</p>
          <p className="mt-1 font-mono text-[0.66rem] text-bone-soft">
            cash {usd(a.cashUsd)} · from peak {pnlPct}%
          </p>
        </div>
        <div className="card p-6">
          <p className="font-mono text-[0.6rem] uppercase tracking-[0.24em] text-bone-soft">Position</p>
          <p className={`font-display mt-2 text-[2rem] font-semibold ${a.position.side === "long" ? "text-jade" : "text-bone-soft"}`}>
        ...
        <div className="card p-6">
          <p className="font-mono text-[0.6rem] uppercase tracking-[0.24em] text-bone-soft">Realized P&L</p>
        ...
        <div className="card p-6">
          <p className="font-mono text-[0.6rem] uppercase tracking-[0.24em] text-bone-soft">Kill switch</p>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-5">
        <section className="card p-6 lg:col-span-3">
          <h2 className="font-mono text-[0.62rem] uppercase tracking-[0.28em] text-bone-soft">Equity curve</h2>
          <EquityCurve points={snap.equityCurve} />
        </section>
        <section className="card p-6 lg:col-span-2">
          <h2 className="font-mono text-[0.62rem] uppercase tracking-[0.28em] text-bone-soft">Desk controls</h2>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-5">
        ...
        <section className="card p-6 lg:col-span-3">
          <h2 className="font-mono text-[0.62rem] uppercase tracking-[0.28em] text-bone-soft">Real-money notes</h2>
          <p className="mt-4 text-[0.85rem] leading-relaxed text-bone-soft">
            Degen Mode executes <strong className="text-ink">real swaps on Base</strong> — USDC ⇄ cbBTC through
          ...
          <p className="mt-3 text-[0.78rem] leading-relaxed text-bone-soft">
