...
const SECTIONS: { heading: string; paras: string[] }[] = [
  ...
  },
  {
    ...
    paras: [
      "Access costs 1,000 satoshis per 30-day period, paid in full via the Lightning Network through our payment processor (ZBD). Access begins when payment confirms and ends 30 days later. There is no auto-renewal, no recurring charge, and no stored payment method — renewal is a deliberate new payment by you.",
      "Because Lightning payments are instant, irreversible, and the product is delivered immediately (access code issuance), all sales are final once a payment confirms and a code is issued. If a payment fails or an invoice expires, no charge occurs. Contact us via the GitHub repository if a confirmed payment did not yield a working code.",
    ],
  },
  {
